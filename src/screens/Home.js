...
import imagea3 from "../assets/img/a-2.jpg"
import teacher1 from "../assets/img/Sugirthamalar-hod.webp"
import teacher2 from "../assets/img/Mr.-R.-Thirumalai-Kumar-AP-BBA.webp"
import teacher3 from "../assets/img/assistant-professor-bba.webp"
import teacher4 from "../assets/img/Dr.-M.-Ranjith-Kumar.webp"
import teacher5 from "../assets/img/sivaratheesh.webp"
import Academic1 from "../assets/img/academpc1.jpg"
import Academic2 from "../assets/img/academpc2.jpg"
import Academic3 from "../assets/img/academpc3.jpg"
import bg from "../assets/img/bg.jpg"
import bg3 from "../assets/img/bg.jpg"
...
const Home = () => {
  ...
  <main>
        ...
        <div className="counter-wrap">
          <div className="row g-0">
            {[
              ...
              { count: 214, text: "Students Enrolled", icon: "fa-user-group" },
    ...
    <section className="h7_program-area pb-90 fix" style={{marginTop:-150}}>
        <div className="program-text-wrap mb-55">
        <div className="section-area-6 mb-55 text-center">
            <span className="section-subtitle" style={{fontSize:43, fontWeight:'bold',marginBottom:23}}>Program and Academics</span>
            </div>
              ...
              <div className="h6_program-item-content">
                <div className="h6_program-item-content-info">
                  <h4 className="h6_program-item-content-info-title">
                    <a href="#">Underground Studies</a>
                  </h4>
                  <a href="#" className="h6_program-item-content-info-link">
                    Read More
            ...
            >
              <div className="section-area-2">
                <h2 className="section-title mb-30">
                  ...
                  <span>
                    Professor <img src={line} alt="" />
                  </span>
                </h2>
              </div>
              <div className="h2_teacher-button">
                <a href="#" className="theme-btn theme-btn-medium teacher-btn">
    ...
    {/* teacher area end */}
      ...
      <div className="container">
      <div className="section-area-6 mb-55 text-center">
            <span className="section-subtitle" style={{fontSize:43, fontWeight:'bold',marginBottom:23}}>Tribute to Our Founder</span>
            </div>
        <div className="row">
          <div className="col-xl-6 col-lg-6">
          ...
          <div className="col-xl-6 col-lg-6" style={{marginTop:100}}>
            <div className="h6_about-content ml-30 mb-30 mb-md-0 pb-30">
              ...
              <p>
              Our Founder, Thiru. AladiAruna M.A., B.L son of the soil, a great prolific reader and an orator,
               was one of the senior-most politicians of Tamilnadu,
               started the institution for providing high-quality technical education to the rural and the weaker section.
              </p>  
              <a
                href="#"
      ...
      <div className="container">
        ...
        <div className="col-xl-6 col-lg-6" style={{marginTop:100}}>
            <div className="h6_about-content ml-30 mb-30 mb-md-0 pb-30">
              ...
              <p>
              To serve humanity through Academic Excellence & Research with values. To enlighten students to 
              become proficient Engineers of exceptional caliber and acquire novel research 
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="h6_about-img w_img">
              <img src={Student} alt="Founder-Image" 
                 style={{
                    width: '100%',
                    height: '450px', // Thumbnail height
                    objectFit: 'cover',
  ...
  <div className="about-text-ticker" id="about-text-ticker">
    <h1 className="h6_about-bottom-title">
     ...
     <section className="h4_about-area pt-140 pb-90">
      <div className="container">
      <div className="section-area-6 mb-55 text-center">
            <span className="section-subtitle" style={{fontSize:43, fontWeight:'bold',marginBottom:23}}>Student Life</span>
            </div>
        <div className="row align-items-center">
          <div className="col-xl-6 col-lg-6">
          ...
          <div className="col-xl-6 col-lg-6 col-md-10">
            <div className="h4_about-wrap mr-65 mb-50">
              ...
              <div className="h4_about-button">
                ...
                <a href="tel:+002455456978" className="h4_about-button-call">
...
Campus recruitment and in-plant training.
      ...
      <div className="section-area-6 mb-55 text-center">
            <span className="section-subtitle" style={{fontSize:43, fontWeight:'bold',marginBottom:23,marginTop:150}}>Campus experience</span>
            </div>
      <section className="h4_education-area pt-130 pb-110"style={{marginTop:50}}>

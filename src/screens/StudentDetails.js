  ...
  return (
    <div>
       <div className="h6_cta-button">
                <Link to='/StudentList' className="h6_cta-btn">
                  Back to Student List
                  <i className="fa-light fa-arrow-up-right" />
                </Link>
              </div>
      <section className="course_details-area pt-20 pb-60">
                        ...
                        <div className="h3_about-img mb-50">
                          <div className="h3_about-inner-img w_img mr-50">
                            {studentDetails?.file_name ? (
                              <img
                                src={`https://ecasadmin.unitdtechnologies.com/storages/${studentDetails.file_name}`}
                                alt="Student"
                              />
                            ) : (
